...
**Earliest reachable commit on `main`:** 2026-07-29  
**Commit:** [`5a5d7cf59566`](https://github.com/poojakira/mlsec-benchmark-suite/commit/5a5d7cf5956623ca42ec82367516820af3ddea2e)  
**Commit message:** `Create reproducible ML security benchmark suite`
...
- Fixture dates and benchmark-source dates are evidence about inputs, not repository inception.
...
|---|---|---|
| Reachable Git history | Earliest reachable commit on `main` | **2026-07-29** — [`5a5d7cf59566`](https://github.com/poojakira/mlsec-benchmark-suite/commit/5a5d7cf5956623ca42ec82367516820af3ddea2e) — `Create reproducible ML security benchmark suite` |
