...
This repository is maintained as a **cross-repository security regression system**.

## Production purpose

run versioned fixture contracts against portfolio adapters and track comparable regression results.

## Release gate

A release is promotable only when adapter/contract tests, schema validation, signing/dataset checks, and reproducibility gates pass.
